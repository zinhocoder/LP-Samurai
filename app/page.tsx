      ...
      <section className="py-12 lg:py-20 bg-gradient-to-r from-yellow-400 to-yellow-600">
        <div className="container mx-auto px-4">
          <div className="text-center text-black fade-in-element">
            <Zap className="w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-6 lg:mb-8" />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-black/10 backdrop-blur-sm rounded-lg p-4 lg:p-6">
                ...
                <p className="font-semibold text-sm lg:text-base">Respostas Políticas</p>
              </div>
              <div className="bg-black/10 backdrop-blur-sm rounded-lg p-4 lg:p-6">
                <ClipboardList className="w-6 h-6 lg:w-8 lg:h-8 mx-auto mb-3 lg:mb-4" />
                <p className="font-semibold text-sm lg:text-base">Relatórios Detalhados</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-yellow-400 border-2 shadow-2xl">
                <CardContent className="p-6 lg:p-12">
                  <div className="text-center mb-6 lg:mb-8">
                    ...
                    <div className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-3 lg:mb-4">R$ 247</div>
                    <p className="text-lg lg:text-xl text-gray-300 mb-6 lg:mb-8">à vista - Acesso imediato</p>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
                    ...
                    <Card className="bg-black/50 border-yellow-400/30 hover:border-yellow-400 transition-all duration-300 sm:col-span-3 lg:col-span-1">
                      <CardContent className="p-4 lg:p-6 text-center">
                        <Zap className="text-yellow-400 w-8 h-8 lg:w-12 lg:h-12 mx-auto mb-3 lg:mb-4" />
                        <h4 className="text-base lg:text-lg font-bold text-yellow-400 mb-2">IA Integrada</h4>
                        <p className="text-gray-300 text-xs lg:text-sm">Tecnologia de ponta</p>
                      </CardContent>
                    </Card>
                  </div>
